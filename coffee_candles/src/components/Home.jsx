...
const Home = () => {
  return (
    <div className='w-full'>
      ...
      >
        <p className='w-full self-center text-5xl p-9 mb-5 font-extrabold'>
          Coffee for everybody.
        </p>
        <button className='border-none w-40 self-center p-3 bg-[#2E4030] text-white mb-40'>
          SHOP
        </button>
      </div>
      <div
        className='absolute flex flex-row py-2 md:min-w-[760px] bottom-[1%] mx-1 
      ...
      >
        ...
        <ul className='flex items-center p-2 font-semibold'>
          <li className='flex px-1 py-1 text-slate-500'>
            <CameraIcon className='h-6 text-zinc-600' /> Instagram
          </li>
          <li className='flex px-1 py-1 text-slate-500'>
            <CheckBadgeIcon className='h-6 text-zinc-600' /> Twitter
          </li>
          <li className='flex px-1 py-1 text-slate-500'>
            <FaceSmileIcon className='h-6 text-zinc-600' /> Facebook
          </li>
          <li className='flex px-1 py-1 text-slate-500'>
            <EnvelopeIcon className='h-6 text-zinc-600' /> Email
          </li>
        </ul>
      </div>
    </div>
